...
# Testing button elements
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator('button.flex:nth-match(6)').click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector='button.flex:nth-match(6)',
                    description='Follow',
                    success=True,  # We got this far without exception
                    screenshot_before=before_screenshot,
                    screenshot_after=after_screenshot,
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('Message'):nth-match(7)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('Message'):nth-match(7)",
                    description='Message',
                    success=True,  # We got this far without exception
                    screenshot_before=before_screenshot,
                    screenshot_after=after_screenshot,
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator('button.py-2:nth-match(8)').click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector='button.py-2:nth-match(8)',
                    description='about',
                    success=True,  # We got this far without exception
                    screenshot_before=before_screenshot,
                    screenshot_after=after_screenshot,
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('experience'):nth-match(9)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('experience'):nth-match(9)",
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('education'):nth-match(10)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('education'):nth-match(10)",
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('skills'):nth-match(1)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('skills'):nth-match(1)",
                    description='skills',
                    success=True,  # We got this far without exception
                    screenshot_before=before_screenshot,
                    screenshot_after=after_screenshot,
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('Try now'):nth-match(2)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('Try now'):nth-match(2)",
                    description='Try now',
                    success=True,  # We got this far without exception
                    screenshot_before=before_screenshot,
                    screenshot_after=after_screenshot,
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator('button.text-sm:nth-match(3)').click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector='button.text-sm:nth-match(3)',
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('App Store'):nth-match(4)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('App Store'):nth-match(4)",
            ...
            try:
                ...
                before_title = page.title()
                # Perform the action
                page.locator("button:has-text('Google Play'):nth-match(5)").click(timeout=3000)
                try:
                    page.wait_for_load_state('networkidle', timeout=5000)
                except Exception as e:
                    print(f'Navigation wait error: {{e}}')
                ...
                element_tracker.record_element_test(
                    page_url=original_url,
                    element_type='button',
                    selector="button:has-text('Google Play'):nth-match(5)",
